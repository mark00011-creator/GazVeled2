-- FLAGA PB és PRÍMA PB körforgásos készlet (darabszám alapú)
...
-- Árlista tételek (beszerzési ár és árrés később kitölthető)
...
DO $$ BEGIN
  ALTER TYPE public.exchange_operation_type ADD VALUE 'flaga_pb_sale';
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TYPE public.exchange_operation_type ADD VALUE 'prima_pb_sale';
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;
