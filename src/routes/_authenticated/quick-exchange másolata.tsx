...
export const Route = createFileRoute("/_authenticated/quick-exchange másolata")({
...
function QuickExchange() {
  ...
  async function complete() {
    ...
    try {
      ...
      setIncomingBc(""); setOutgoingBc(""); setIncoming(null); setOutgoing(null);
      setIncomingCreated(false); setOutgoingCreated(false);
      setNote(""); setReason(""); setReassign(null);
