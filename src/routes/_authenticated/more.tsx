...
import { Truck, FileText, RotateCcw, ScrollText, ChevronRight, ClipboardList, Package, Tags } from "lucide-react";
...
const items = [
  ...
  { to: "/price-list", icon: Tags, label: "Árlista", desc: "Csereárak szerkesztése (számlázás alap)" },
