...
type LocationType = CylinderRow["location_type"];
type CylinderStatus = CylinderRow["status"];
...
const STATUSES: CylinderStatus[] = ["full", "empty", "service"];
  ...
  const { data } = useQuery({
    ...
    queryFn: async () => {
      let qb = supabase
        .from("cylinders")
        .select(
          "id, barcode, gas_type, size, circulation, owner, status, location_type, location_partner_id, location_supplier_id, suppliers:location_supplier_id(name), partners:location_partner_id(name)",
        )
        .eq("active", true)
        .order("barcode");
  ...
  async function saveEdit() {
    ...
    try {
      await updateCylinder(editingId, {
        ...
        status: editingForm.status as CylinderStatus,
        location_type: editingForm.location_type as LocationType,
    ...
    <AppShell title="Palackok">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(v) =>
                      setNewForm({ ...newForm, circulation: v as "own" | "siad" })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
      ...
      <div className="mb-3 grid grid-cols-2 gap-2">
        <Select value={circ} onValueChange={setCirc}>
          <SelectTrigger>
            <SelectValue placeholder="Körforgás" />
          </SelectTrigger>
          <SelectContent>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(v) =>
                          setEditingForm({ ...editingForm, location_type: v as LocationType })
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(v) =>
                          setEditingForm({ ...editingForm, status: v as CylinderStatus })
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
